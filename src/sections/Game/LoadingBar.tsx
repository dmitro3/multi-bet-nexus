import { decodeGame, getGameAddress } from 'multi-bet-nexus-core-v2'
import { useAccount, useTransactionStore, useWalletAddress } from 'multi-bet-nexus-react-v2'
...
const StyledLoadingBar = styled.div<{$state: 'finished' | 'loading' | 'none'}>`
  ...
  border-radius: 10px;
  flex-grow: 1;
  background: var(--multi-bet-nexus-ui-primary-color);
  color: black;
  padding: 0 10px;
  font-size: 12px;
  height: 6px;
