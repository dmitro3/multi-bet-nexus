import { BPS_PER_WHOLE, multi-bet-nexusTransaction } from 'multi-bet-nexus-core-v2'
import { multi-bet-nexusUi, TokenValue, useTokenMeta } from 'multi-bet-nexus-react-ui-v2'
...
function RecentPlay({ event }: {event: multi-bet-nexusTransaction<'GameSettled'>}) {
  ...
  return (
    <>
      ...
      <div style={{ color: 'var(--multi-bet-nexus-ui-primary-color)' }}>
...
export default function RecentPlays() {
  ...
  const [selectedGame, setSelectedGame] = React.useState<multi-bet-nexusTransaction<'GameSettled'>>()
  const md = useMediaQuery('md')
  ...
  return (
    <Container>
      ...
      <multi-bet-nexusUi.Button main onClick={() => window.open(`${EXPLORER_URL}/platform/${PLATFORM_CREATOR_ADDRESS.toString()}`)}>
        🚀 Explorer
