import { multi-bet-nexusUi, TokenValue, useCurrentPool, usemulti-bet-nexusPlatformContext, useUserBalance } from 'multi-bet-nexus-react-ui-v2'
...
export default function Header() {
  ...
  const context = usemulti-bet-nexusPlatformContext()
    ...
    <>
      ...
      <StyledHeader>
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          <Logo to="/">
            <img alt="multi-bet-nexus logo" src="/logo.svg" />
          </Logo>
        </div>
