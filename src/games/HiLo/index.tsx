    ...
    <>
      <multi-bet-nexusUi.Portal target="screen">
        <multi-bet-nexusUi.Responsive>
          <Container $disabled={claiming || multi-bet-nexus.isPlaying}>
      ...
      <multi-bet-nexusUi.Portal target="controls">
        {!profit ? (
          <>
            ...
            />
            <multi-bet-nexusUi.PlayButton disabled={!option || initialWager > maxWagerForBet} onClick={play}>
              Deal card
            </multi-bet-nexusUi.PlayButton>
            {initialWager > maxWagerForBet && (
              <multi-bet-nexusUi.Button onClick={() => setInitialWager(maxWagerForBet)}>
                Set max
          ...
          <>
            ...
            <multi-bet-nexusUi.Button disabled={multi-bet-nexus.isPlaying} onClick={resetGame}>
              Finish
            </multi-bet-nexusUi.Button>
            <multi-bet-nexusUi.PlayButton disabled={!option} onClick={play}>
              Deal card
            </multi-bet-nexusUi.PlayButton>
          </>
        )}
