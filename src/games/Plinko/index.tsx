import { multi-bet-nexusUi, useSound, useWagerInput } from 'multi-bet-nexus-react-ui-v2'
    ...
    <>
      ...
      <multi-bet-nexusUi.Portal target="controls">
        ...
        {window.location.origin.includes('localhost') && (
          <>
            <multi-bet-nexusUi.Switch checked={debug} onChange={setDebug}  />
            <multi-bet-nexusUi.Button onClick={() => plinko.single()}>
              Test
            </multi-bet-nexusUi.Button>
            <multi-bet-nexusUi.Button onClick={() => plinko.runAll()}>
              Simulate
            </multi-bet-nexusUi.Button>
          </>
        )}
