  ...
  return (
    <>
      ...
      <multi-bet-nexusUi.Portal target="controls">
        {!started ? (
          <>
            <multi-bet-nexusUi.WagerInput value={initialWager} onChange={setInitialWager} />
            ...
            />
            <multi-bet-nexusUi.PlayButton onClick={start}>
              Start
            </multi-bet-nexusUi.PlayButton>
          </>
        ) : (
          <multi-bet-nexusUi.Button onClick={endGame}>
