...
import { FAKE_TOKEN_MINT, PoolToken, TokenMeta, makeHeliusTokenFetcher } from 'multi-bet-nexus-react-ui-v2'
...
// multi-bet-nexus explorer URL - Appears in RecentPlays
export const EXPLORER_URL = 'https://explorer.multi-bet-nexus.so'

// Platform URL - Appears in ShareModal
export const PLATFORM_SHARABLE_URL = 'play.multi-bet-nexus.so'
 ...
 * Make sure the token you want to list has a corresponding pool on https://explorer.multi-bet-nexus.so/pools
