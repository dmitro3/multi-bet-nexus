 ...
 * App
 * @path src/App.tsx
 * @description The main application component for the multi-bet-nexus platform.
 */
import { useWalletModal } from '@solana/wallet-adapter-react-ui'
import { multi-bet-nexusUi } from 'multi-bet-nexus-react-ui-v2'
import { useTransactionError } from 'multi-bet-nexus-react-v2'
    ...
    <>
      {newcomer && (
        <Modal>
          ...
          <multi-bet-nexusUi.Button main onClick={() => set({ newcomer: false })}>
            Acknowledge
